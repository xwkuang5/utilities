...
def compute_scores(labels, predictions, proba=None, average=None, classes=None, title="Metrics", verbose=True):
    ...
    if average == None:
        num_classes = len(scores["f1"])

        matrix = np.stack([scores["f1"], scores["precision"], scores["recall"]])
